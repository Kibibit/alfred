...
const optionDefinitions = [
  { name: 'username', alias: 'u', type: String, typeLabel: '{underline username}', description: 'The jenkins username to run the jobs with' },
  { name: 'password', alias: 'p', type: String, typeLabel: '{underline password}', description: 'The jenkins password for the given username' },
  { name: 'instance-url', alias: 'i', type: String, typeLabel: '{underline url}', description: 'Jenkins instance URL' },
  { name: 'job', alias: 'j', type: String, typeLabel: '{underline jobName}', description: 'The specific job to run' },
